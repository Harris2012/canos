...
#include "cn_ranta_canos_engine_color.h"

JNIEXPORT jstring JNICALL
Java_cn_ranta_canos_engine_filter_BasicFilter_test(JNIEnv *env) {
...
Java_cn_ranta_canos_engine_filter_BasicFilter_gray(JNIEnv *env, jobject obj, jintArray srcPixels, jint width, jint height, jfloat factor) {
    ...
    jint * pixels = 0;
    pixels = (*env)->GetIntArrayElements(env, srcPixels, JNI_FALSE);
    if (pixels == 0) {
        return srcPixels;
    }
    ...
    jintArray resultArray = (*env)->NewIntArray(env, size);
    (*env)->SetIntArrayRegion(env, resultArray, 0, size, result);
    (*env)->ReleaseIntArrayElements(env, srcPixels, pixels, 0);
    return resultArray;
}

JNIEXPORT jintArray JNICALL
Java_cn_ranta_canos_engine_filter_BasicFilter_mosatic(JNIEnv *env, jobject obj, jintArray srcPixels, jint width, jint height,
                  jint factor) {
    jint * pixels = NULL;
...
JNIEXPORT jintArray JNICALL
Java_cn_ranta_canos_engine_filter_BasicFilter_lomo(JNIEnv *env, jobject obj, jintArray srcPixels, jint width, jint height,
               jfloat factor) {
    jint * pixels = NULL;
...
JNIEXPORT jintArray JNICALL
Java_cn_ranta_canos_engine_filter_BasicFilter_nostalgic(JNIEnv *env, jobject obj, jintArray srcPixels, jint width, jint height,
                    jfloat factor) {
    jint * pixels = NULL;
...
JNIEXPORT jintArray JNICALL
Java_cn_ranta_canos_engine_filter_BasicFilter_comics(JNIEnv *env, jobject obj, jintArray srcPixels, jint width, jint height,
                 jfloat factor) {
    jint * pixels = NULL;
...
JNIEXPORT jintArray JNICALL
Java_cn_ranta_canos_engine_filter_BasicFilter_brown(JNIEnv *env, jobject obj, jintArray srcPixels, jint width, jint height,
                jfloat factor) {
    jint * cbuf;
    cbuf = (*env)->GetIntArrayElements(env, srcPixels, JNI_FALSE);
    ...
    (*env)->SetIntArrayRegion(env, result, 0, size, buffTemp);
    (*env)->ReleaseIntArrayElements(env, srcPixels, cbuf, 0);
    return result;
}
